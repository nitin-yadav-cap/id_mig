...
def populate_fk():
    tab_pk_map = {}
    # tab_comp_pk_map = {}
    tpk_lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/all_external_meta_tables.txt')
    for l in tpk_lines:
        sp = l.split('#')
    ...
    lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/external_fk_details.txt')
    sqls = []
    for line in lines:
        #print(line)
        sp = line.split(':')
