...
def load_base_data():
    lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/base_tables.txt')
    for line in lines:
        sp = line.split('#')
...
def load_all_ids():
    lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/all_tables.txt')
...
def populate_fk():
    tab_pk_map = {}
    tab_comp_pk_map = {}
    tpk_lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/all_tables.txt')
    for l in tpk_lines:
        sp = l.split('#')
    ...
    lines = read_conf('/Users/nitin/Documents/cap/id_mig/src/fk_details.txt')
    sqls = []
    for line in lines:
        #print(line)
        sp = line.split(':')
        ...
        for row in cursor:
            for x in sp1:
                ...
                if table_name == "source_target_column_mapping":
                    print(sql_str)
                sqls.append(sql_str)
