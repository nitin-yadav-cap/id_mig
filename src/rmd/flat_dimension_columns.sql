CREATE TABLE `flat_dimension_columns` (
  ...
  `data_type` enum('TEXT','NUMBER','BIGNUMBER','BOOLEAN','DATE','TIME','MAP') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TEXT',
  ...
  `usability_type` enum('DUMP_ONLY','PARTIAL_KEY','SELECT','FILTER','GROUP','BANDING') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SELECT',
  ...
  `scd_dimension_table_id` int DEFAULT NULL,
  `computation_type` enum('ETL','VIEW') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ETL',
  `location_table_type` enum('FACT','DIMENSION','VIEW','ATTR') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DIMENSION',
  ...
  `key_set_resolver` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `map_key_data_type` enum('TEXT','NUMBER','BIGNUMBER','BOOLEAN','DATE','TIME') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `map_value_data_type` enum('TEXT','NUMBER','BIGNUMBER','BOOLEAN','DATE','TIME') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `scd_dimension_table_id_str` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
