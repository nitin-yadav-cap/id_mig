CREATE TABLE `scd_dimension_columns` (
  `column_id` int NOT NULL AUTO_INCREMENT,
  `dim_table_id` int NOT NULL,
  `column_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `column_type` enum('PK','ATTRIBUTE','DATE_ATTRIBUTE','TIME_ATTRIBUTE','START_DATE','END_DATE','NONE','CHANGING_ATTRIBUTE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NONE',
  ...
  `functional_dependency_column` int NOT NULL,
